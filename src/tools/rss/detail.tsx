            ...
            feeds.map((feed) => (
              ...
              >
                ...
                <div className="mt-3 flex items-center justify-between text-xs text-slate-400">
                  <span>更新：{formatDateTime(new Date(feed.updatedAt))}</span>
                  <button
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <button
                        ...
                        className="shrink-0 rounded-full border border-amber-400/40 bg-amber-400/10 px-3 py-1 text-xs font-semibold text-amber-200 hover:bg-amber-400/20"
                      >
                        查看详情
                      </button>
                    </div>
